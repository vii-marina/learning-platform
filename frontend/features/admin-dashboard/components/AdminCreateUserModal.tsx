...
export function AdminCreateUserModal({
  ...
  return (
    <Modal
      ...
      panelClassName="w-full max-w-xl rounded-[1.75rem] border border-cyan-100 bg-white p-6 shadow-[0_28px_60px_rgba(15,23,42,0.22)] md:p-7"
    >
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <h2
              id={headingId}
              className="mt-1 text-2xl font-black tracking-tight text-[#14213d]"
            >
              Створити акаунт
            </h2>
            <p className="mt-2 text-sm leading-6 text-slate-500">{labels.subtitle}</p>
          </div>
        </div>
